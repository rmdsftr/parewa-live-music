...
<body>
    <nav>
        ...
        <div class="menu">
            ...
            <a href="registration" id="schedule" class="inactive">Schedule</a>
    ...
    <main>
        ...
        <div class="right-content">
            ...
            <div class="youtube-container">
                <iframe 
                    src="https://www.youtube.com/embed/QEk6w_Bk1Po" 
            ...
            <div class="performance-history">
                @foreach($performances as $performance)
                    <div class="card">
                        <video src="{{ asset('storage/' .$performance->video) }}" controls poster="{{ asset($performance->video) }}"></video>
                        <div class="caption">
